...
const translations = {
  en: {
    ...
    'hero.stat2.number': '3',
    'hero.stat2.label': 'countries',
    'hero.stat3.number': '20+',
    'hero.stat3.label': 'engineering teams',
    ...
    'service.cta.title': 'Not sure where to start?',
    'service.cta.desc': 'A scoped discovery session helps define the right engagement for your stage and goals.',
    'service.cta.btn': 'Book a Discovery Session',
  ...
  ja: {
    ...
    'hero.cta2': 'サービスを見る',
    'hero.stat1.number': '10+',
    'hero.stat1.label': '年の経験',
    'hero.stat2.number': '3',
    'hero.stat2.label': 'カ国',
    'hero.stat3.number': '20+',
    'hero.stat3.label': 'エンジニアリングチーム',
    ...
    'service.cta.title': 'どこから始めるか迷っていますか？',
    'service.cta.desc': 'スコープ付きディスカバリーセッションで、最適なエンゲージメントを見つけましょう。',
    'service.cta.btn': 'ディスカバリーセッションを予約',
    'proof.tag': '登壇・発表',
    'proof.title': '活動実績',
  ...
  ko: {
    ...
    'service.cta.title': '어디서부터 시작할지 모르겠나요?',
    'service.cta.desc': '범위가 정의된 디스커버리 세션으로 최적의 참여 방식을 찾아드립니다.',
    'service.cta.btn': '디스커버리 세션 예약',
    'proof.tag': '발표 및 기고',
    'proof.title': '활동 이력',
